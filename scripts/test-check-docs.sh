...
export CHECK_DOCS_TEST_TOTALS="test-hooks.sh=106,test-trace-check.sh=15,test-quality-harness.sh=11,test-install.sh=116,test-git-gates.sh=27,test-json-envelope.sh=13"
