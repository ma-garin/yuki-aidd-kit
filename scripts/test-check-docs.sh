...
export CHECK_DOCS_TEST_TOTALS="test-hooks.sh=45,test-trace-check.sh=15,test-quality-harness.sh=11,test-install.sh=79,test-git-gates.sh=27"
...
echo "[ケース4: ケース数のズレ]"
C=$(fresh)
OUT=$(CHECK_DOCS_TEST_TOTALS="test-hooks.sh=46,test-trace-check.sh=15,test-quality-harness.sh=11,test-install.sh=73,test-git-gates.sh=27" run "$C"); RC=$?
