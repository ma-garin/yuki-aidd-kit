...
export CHECK_DOCS_TEST_TOTALS="test-hooks.sh=193,test-trace-check.sh=15,test-quality-harness.sh=11,test-install.sh=148,test-agents.sh=57,test-git-gates.sh=27"
