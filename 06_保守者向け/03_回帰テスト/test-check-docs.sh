...
export CHECK_DOCS_TEST_TOTALS="test-hooks.sh=620,test-trace-check.sh=15,test-quality-harness.sh=11,test-install.sh=136,test-agents.sh=57,test-git-gates.sh=27"
