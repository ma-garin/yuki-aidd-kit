...
export CHECK_DOCS_TEST_TOTALS="test-hooks.sh=712,test-trace-check.sh=70,test-quality-harness.sh=11,test-install.sh=156,test-agents.sh=63,test-git-gates.sh=27"
