...
- **プリセットを持たない**: 真実源は `01_利用者向け資料/ECC-ASSET-MAP.md` の Project Mapping（AUDIT A-03 で全文削除）。該当が無ければスタックから選び **MAP への追記案を出す**
...
- **現況**: `02_共通/ひな形/lessons.md` はエントリ0件。このループは未稼働（`06_保守者向け/内部仕様/09-findings.md` F-05）
