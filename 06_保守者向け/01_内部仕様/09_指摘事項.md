...
**是正案**: 機械導出に置き換える（`06_保守者向け/01_内部仕様/10_バックログ.md` B-01）。手で直すだけでは必ず再発する。
...
**是正案**: `06_保守者向け/01_内部仕様/10_バックログ.md` B-01。
...
**是正案**: `06_保守者向け/01_内部仕様/10_バックログ.md` B-01（`06_保守者向け/03_回帰テスト/check-docs.sh`）。
