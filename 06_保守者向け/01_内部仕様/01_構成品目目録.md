...
## 05_プロジェクト管理/・06_保守者向け/（14件・1,470行）— 計画と保守者専用（配布しない）。`06_保守者向け/01_内部仕様/` は本目録の対象外
...
| `EXTERNAL-REF-awesome-2026-09.md` | 88 | 外部参照調査（sindresorhus/awesome）。移植候補 E-1〜E-7・未カバー領域の一次資料 R-1〜R-7・メンター化の差分 G-1〜G-3・採用しない理由・未確認 X-1〜X-4 |
