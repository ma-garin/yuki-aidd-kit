...
| ファイル | 行 | 役割 |
|---|---|---|
| `README.md` | 314 | 人間向けの入口。版歴（Ver.5.0〜6.4）・導入2方式・推奨フロー・構成ツリー・合言葉 |
...
| `.claude/settings.json` | 39 | キット自身の開発セッション用の hooks 配線（instruction-guard / prompt-priority / reply-language を `$CLAUDE_PROJECT_DIR` 参照で）。配布形は `claude-code/hooks/settings.json`（M22） |
...
| `README.md` | 314 | **どのファイルをどのフレームワークでどこに置くか**の1枚表（単一 HTML / PWA / React+Vite+Tailwind / Streamlit / Flask・Django）＋検証手順 |
...
| `Roadmap.md` | 295 | **キット開発の作業台帳**。作業ルール5条と M1〜M14。未完チェック2件 |
