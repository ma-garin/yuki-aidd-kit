...
使い方:  python3 00_導入/install_guard.py [--home <HOME>] [--hooks-dir <キットの hooks>]
...
def main() -> int:
    ...
    ap.add_argument("--hooks-dir", default=str(Path(__file__).resolve().parent.parent / "03_ClaudeCode" / "hooks"))
    a = ap.parse_args()
    home = Path(a.home)
    claude = home / ".claude"
