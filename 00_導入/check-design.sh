...
# 使い方: ./00_導入/check-design.sh [--root DIR] [--tokens 02_共通/ひな形/tokens.css] [-o REPORT] [PATH ...]
#   PATH 省略時は 02_共通/ひな形/ui templates/components。配布先では ./00_導入/check-design.sh static src 等を指定する。
