...
for s in pre-commit quality_harness.py ui-hash.py pre-commit-ui-gate.sh check_approval.py check-approval.sh phase-hash.py req-lint.py cite-check.py test_metrics.py test-metrics.sh md-section.py section_hash.py adr-to-rules.py security-scan.sh; do
